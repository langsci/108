\title Investigating Cognitive Effort in Post-editing 

\begin{styleSubtitle}
A relevance-theoretical approach
\end{styleSubtitle}

Fabio Alves (UFMG, \href{mailto:fabio-alves@ufmg.br}fabio-alves@ufmg.br)

Karina Sarto Szpak (UFMG, \href{mailto:kszpak@ufmg.br}kszpak@ufmg.br)

José Luiz Gonçalves (UFOP, \href{mailto:zeluizvr@ichs.ufop.br}zeluizvr@ichs.ufop.br)

Kyoko Sekino (UFMG, \href{mailto:kyokosekino@ufmg.br}kyokosekino@ufmg.br)

Marceli Aquino (UFMG, \href{mailto:marceliaquinoufmg@gmail.com}marceliaquinoufmg@gmail.com)

Rodrigo Araújo de Castro (UFMG, \href{mailto:roacastro87@yahoo.com.br}roacastro87@yahoo.com.br)

Arlene Koglin (UFMG, \href{mailto:arlenekoglin@yahoo.com.br}arlenekoglin@yahoo.com.br)

Norma B. de Lima Fonseca (UFMG, \href{mailto:normafonseca@ufmg.br}normafonseca@ufmg.br)

Bartolomé Mesa-Lao (CBS, \href{mailto:Bm.ibc@cbs.dk}Bm.ibc@cbs.dk)
...
\section{The principle of relevance}
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Sarto1.png}
...
\section{Interpretive resemblance}
...
\section{Conceptual and procedural encodings}
...
\section{Post-editing, relevance and encoding}
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Sarto2.png}
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Sarto3.png}
...
\section{Procedures for data analysis}
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Sarto4.png}
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Sarto5.png}
...
\subsection{Fixation count, fixation duration and the average of fixation duration}
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Sarto6.png}
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Sarto7.png}
...
\subsection{Relating the encoding data and the eye-tracking data.}
...
\subsection{Considerations about edits on encodings}
...
\subsection{Considerations about the eye-tracking data}
