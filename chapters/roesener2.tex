...
% 		    anchor=west},
	...
	\addplot[ybar,lsRichGreen!80!black,fill=lsRichGreen] plot coordinates {(yes,49) (no,43) (do not visit,8)};
    \end{axis} 
...
\begin{figure}[t]
 ...
 \caption{Eye tracking workstation (top left), mobile eye tracker (top right), eye-tracking glasses (bottom; Tobii 2014 / SMI 2014)}
