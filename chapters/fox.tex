...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Fox1.png}
 \caption{Frontal shots of the interviewees in Joining the Dots (UK 2012}
  \label{fig:1}
\end{figure}  

\begin{figure}[h]
 \includegraphics[width=\textwidth]{Fox2.png}
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Fox3.png}
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Fox4.png}
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Fox5.png}
...
\begin{figure} [h]
  \includegraphics[height=.3\textheight]{Fox6.png}
...
\begin{figure} [h]
  \includegraphics[height=.3\textheight]{Fox7.png}
  \caption{Comparison of split-attention in IT and TS participants}
  \label{fig:7}
\end{figure}

\begin{figure} [h]
  \includegraphics[height=.3\textheight]{Fox8.png}
  \caption{Comparison of the average total visit duration of the IT und TS participants}
  \label{fig:8}
\end{figure}
...
\begin{figure} [h]
  \includegraphics[height=.3\textheight]{Fox9.png}
...
\begin{figure} [h]
  \includegraphics[height=.3\textheight]{Fox10.png}
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Fox11.png}
