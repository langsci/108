\title{The impact of nominalisations on the reading process.}
...
\textit{wolfer@ids-mannheim.de}

\begin{abstract}
We present a study using eye-tracking-while-reading data from participants reading German jurisdictional texts. We are particularly interested in nominalisations. It can be shown that nominalisations are read significantly longer than other nouns and that this effect is quite strong. Furthermore, the results suggest that nouns are read faster in reformulated texts. In the reformulations, nominalisations were transformed into verbal structures. Reformulations did not lead to increased processing times of verbal constructions but reformulated texts were read faster overall. Where appropriate, results are compared to a previous study of \citet{HansenEtAl2006} using the same texts but other methodology and statistical analysis. 
\end{abstract}
...
\section{\label{bkm:Ref283725774}Optimising the comprehensibility of jurisdictional language}
...
\section{\label{bkm:Ref283725832}Reading corpora}
...
\chapter{\label{bkm:Ref283224577}The Freiburg Legalese Reading Corpus}
...
\section{\label{bkm:Ref281991215}Language material}
...
\section{\label{bkm:Ref283222793}Eye-tracking data}
...
\chapter{\label{bkm:Ref283726002}The impact of nominalisations on the reading process}
...
\section{\label{bkm:Ref282241102}Data selection and preparation}
...
\section{\label{bkm:Ref283726131}Hypotheses}
...
\section{\label{bkm:Ref283726141}Results}
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Wolfer1.png}
